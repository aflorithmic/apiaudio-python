...
- `create()` Send a Text-To-Speech request to our Text-To-Speech service.
  - Parameters:
    ...
    - `useDictionary` (bool) - Applies lexi to the script text.
...
To use lexi end-to-end ensure that you supply a voice whose language matches that of the language od the dictionary you wish to use, and then supply `useDictionary=true` to the speech create call (see the example below).
